...
public class RebellionVersionDetailPreferenceController extends BasePreferenceController {

    private static final String TAG = "RebellionVersionDialogCtrl";
    ...
    public RebellionVersionDetailPreferenceController(Context context, String key) {
        super(context, key);
