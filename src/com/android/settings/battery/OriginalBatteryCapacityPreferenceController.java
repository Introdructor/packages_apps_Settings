...
public class OriginalBatteryCapacityPreferenceController extends AbstractPreferenceController implements
        PreferenceControllerMixin {

    private static final String KEY_CHARGE_FULL = "charge_full";
    private int CHARGE_FULL_DIVIDER = 1000;

    public OriginalBatteryCapacityPreferenceController(Context context) {
        super(context);
    }
    ...
    public void updateState(Preference preference) {
        ...
        preference.setSummary(getOriginalBatteryCapacity());
    }
